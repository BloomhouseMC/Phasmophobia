...
public class RevenantEyesFeatureRenderer extends GeoLayerRenderer<UngodlyRevenantEntity> {
    ...
    private final IGeoRenderer<UngodlyRevenantEntity> renderer;

    public RevenantEyesFeatureRenderer(IGeoRenderer<UngodlyRevenantEntity> entityRendererIn, RevenantEyesRenderer model) {
        super(entityRendererIn);
        this.renderer = model;
    }

    @Override
    public void render(MatrixStack matrixStackIn, VertexConsumerProvider bufferIn, int packedLightIn, UngodlyRevenantEntity entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch) {
